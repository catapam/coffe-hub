...
from .views import ProductListView, ProductDetailView, ProductDeactivateView, ReviewSilenceToggler, VariantDeactivateView, SaveSelector, ProductSaveView, ProductCreateView
